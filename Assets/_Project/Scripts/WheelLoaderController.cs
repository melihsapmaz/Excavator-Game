...
namespace _Project.Scripts {
    public class WheelLoaderController : BaseVehicleController {
        ...
        [SerializeField] private HingeJoint arm1Joint;
        
        [Tooltip("Second arm joint that connects the first arm segment to the second arm segment.")]
        [SerializeField] private HingeJoint arm2Joint;
        
        [Header("Arm Movement Settings")]
        
        [Tooltip("Multiplier for the arm movement speed.")]
        [SerializeField] private float armSpeed = 1f;
        
        [Tooltip("Maximum motor force to move and keep the arm in position.")]
